...
execute 'gem_install_rubocop' do
  command "su #{username} -l -c 'source ~#{username}/.rvm/scripts/rvm && gem install rubocop'"
end

execute 'gem_install_foodcritic' do
  command "su #{username} -l -c 'source ~#{username}/.rvm/scripts/rvm && gem install foodcritic'"
end
